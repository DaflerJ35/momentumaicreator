          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
            {[
              ...
              },
              {
                ...
                answer: 'Yes, we offer a 3-day free trial that requires a payment method for account security. No charges will be made during the trial period. After the trial, you can choose to upgrade to a paid plan or continue with the free plan.'
              },
              {
