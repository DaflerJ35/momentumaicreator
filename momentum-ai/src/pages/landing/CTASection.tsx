  ...
  return (
    <section className="relative py-32 overflow-hidden section-bg-premium">
      <div className="absolute inset-0 z-0">
        <div className="nebula-glow-enhanced w-[700px] h-[700px] bg-neon-magenta top-10 left-10 opacity-40" />
        <div className="nebula-glow-enhanced w-[600px] h-[600px] bg-neon-blue bottom-10 right-10 opacity-[0.35]" />
        <div className="nebula-glow-enhanced w-[550px] h-[550px] bg-neon-violet top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-30" />
      </div>
