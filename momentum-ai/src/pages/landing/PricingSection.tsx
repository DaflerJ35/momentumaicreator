...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="relative py-32 overflow-hidden section-bg-premium">
      <div className="absolute inset-0 z-0">
        <div className="nebula-glow-enhanced w-[600px] h-[600px] bg-neon-magenta top-10 left-1/4" style={{ opacity: 0.3 }} />
        <div className="nebula-glow-enhanced w-[550px] h-[550px] bg-neon-violet bottom-10 right-1/4" style={{ opacity: 0.28 }} />
        <div className="nebula-glow-enhanced w-[500px] h-[500px] bg-neon-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ opacity: 0.25 }} />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {plans.map((plan, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`premium-card premium-card-holographic p-8 relative ${
                plan.popular
                  ? "border-2 border-neon-magenta shadow-[0_0_40px_hsl(var(--neon-magenta))]"
                  : ""
              } group`}
            >
              {plan.popular && (
                <div className="absolute -inset-1 bg-gradient-to-r from-neon-magenta via-neon-violet to-neon-magenta rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-500 -z-10" />
              )}
              {plan.popular && (
