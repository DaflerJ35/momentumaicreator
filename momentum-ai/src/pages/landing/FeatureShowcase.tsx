  ...
  return (
    <section className="relative py-32 overflow-hidden section-bg-premium">
      <div className="absolute inset-0 z-0">
        <div className="nebula-glow-enhanced w-[600px] h-[600px] bg-neon-blue top-10 right-20" style={{ opacity: 0.3 }} />
        <div className="nebula-glow-enhanced w-[500px] h-[500px] bg-neon-violet bottom-10 left-20" style={{ opacity: 0.25 }} />
        <div className="nebula-glow-enhanced w-[450px] h-[450px] bg-neon-magenta top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ opacity: 0.2 }} />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-neon-blue/8 via-transparent to-neon-magenta/8 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-neon-blue/15 rounded-full blur-3xl group-hover:bg-neon-blue/25 transition-all duration-500" />
              <div className="absolute -bottom-16 -left-16 w-36 h-36 bg-neon-violet/12 rounded-full blur-2xl group-hover:bg-neon-violet/22 transition-all duration-500" />
