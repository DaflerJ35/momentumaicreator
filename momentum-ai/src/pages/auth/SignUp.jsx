  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message) {
        ...
        toast.error('Account creation disabled. Please contact support.');
        ...
        setError('Failed to create an account. Please try again. If the problem persists, contact support.');
        toast.error('Failed to create an account. Please try again.');
      }
      
      // Log full error in development
      if (import.meta.env.DEV) {
        console.error('Full sign up error details:', {
          code: err.code,
          message: err.message,
          stack: err.stack,
        });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Start your 3-day free trial</p>
        </div>
