        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="relative glass-morphism p-10 rounded-3xl border border-border/30 hover:border-neon-magenta/50 transition-all duration-500 group cursor-pointer overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-neon-magenta/5 via-transparent to-neon-violet/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute -top-20 -left-20 w-40 h-40 bg-neon-magenta/10 rounded-full blur-3xl group-hover:bg-neon-magenta/20 transition-all duration-500" />
